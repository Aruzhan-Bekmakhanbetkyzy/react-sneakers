...
function App() {
  ...
  React.useEffect(() => {
    axios.get('https://62da48b69eedb699636a3b8e.mockapi.io/items').then((res) => {
      setItems(res.data);
    });
    axios.get('https://62da48b69eedb699636a3b8e.mockapi.io/cart').then((res) => {
    ...
    <div className="wrapper clear">
      ...
      <div className='content p-40'>
        <div className='d-flex align-center justify-between mb-40'>
          <h1>{searchValue ? `Searсh by request: "${searchValue}"` : 'All Sneakers'}</h1>
